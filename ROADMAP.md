...
| **L** | **Campo Durata + rata stimata real-time in Step 1** | **v1.3.0** |
| **L** | **Campo Cliente / Riferimento Pratica (DB, archivio, PDF, Excel)** | **v1.3.0** |
| **L** | **Archivio con ricerca testo libero + filtri (tipo, score, usura)** | **v1.3.0** |
| **L** | **Report PDF sezione narrativa "Cosa significa?" — linguaggio semplice** | **v1.3.0** |

---

## 🔜 Prossima sessione — v1.4.0

### 1. Soglie usura automatiche (scraping BdI)
- **Priorità:** Media
...
### 3. Confronto pratiche side by side
- **Priorità:** Bassa
