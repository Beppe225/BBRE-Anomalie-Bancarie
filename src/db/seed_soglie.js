 ...
 * Formula: ante-2011 = TEGM*1.5 | post-2011 = TEGM+25%+4pp (max delta 8pp)
 */

function seedSoglieUsura(db) {
  console.log('📊 Inserimento soglie usura storiche...');

  // [anno, trimestre, tipo, TEGM%]
  const soglie = [
    // MUTUI IPOTECARI
  ...
  db.run("COMMIT");
  console.log(`✅ Inserite ${soglie.length} soglie usura (2005-2026, copertura trimestrale completa)`);
}
