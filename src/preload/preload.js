...
const CANALI_VALIDI = [
  ...
  'carica-documento', 'apri-dialog-file', 'salva-config-llm', 'get-config-llm', 'elimina-analisi', 'get-market-data'
];
...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getConfigLLM: () => ipcRenderer.invoke('get-config-llm', 'elimina-analisi', 'get-market-data')
});
